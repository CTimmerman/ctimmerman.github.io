	...
	document.querySelectorAll('.square').forEach(el => {
		...
		el.onmouseup = async function(e)  {
			if (editmode.checked) {
				...
				let html = `
					<button class="bf w" onclick="board.grid[${i}] = ${EMPTY}; hide_modal()"> </button>
					<button class="bf w" onclick="board.grid[${i}] = new King(${x}, ${y}, 1); hide_modal()">♚</button>
					<button class="bf w" onclick="board.grid[${i}] = new Queen(${x}, ${y}, 1); hide_modal()">♛</button>
					<button class="bf w" onclick="board.grid[${i}] = new Bishop(${x}, ${y}, 1); hide_modal()">♝</button>
					<button class="bf w" onclick="board.grid[${i}] = new Knight(${x}, ${y}, 1); hide_modal()">♞</button>
					<button class="bf w" onclick="board.grid[${i}] = new Rook(${x}, ${y}, 1); hide_modal()">♜</button>
					<button class="bf w" onclick="board.grid[${i}] = new Pawn(${x}, ${y}, 1); hide_modal()">♟︎</button><br>
					<button class="bf w" onclick="board.grid[${i}] = new King(${x}, ${y}, 0); hide_modal()">♔</button>
					<button class="bf w" onclick="board.grid[${i}] = new Queen(${x}, ${y}, 0); hide_modal()">♕</button>
					<button class="bf w" onclick="board.grid[${i}] = new Bishop(${x}, ${y}, 0); hide_modal()">♗</button>
					<button class="bf w" onclick="board.grid[${i}] = new Knight(${x}, ${y}, 0); hide_modal()">♘</button>
					<button class="bf w" onclick="board.grid[${i}] = new Rook(${x}, ${y}, 0); hide_modal()">♖</button>
					<button class="bf w" onclick="board.grid[${i}] = new Pawn(${x}, ${y}, 0); hide_modal()">♙</button>
					`
				show_modal(html)
